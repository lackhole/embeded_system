...
#ifndef EMBED_LOGGER_H_
#define EMBED_LOGGER_H_
...
//  template<typename ...Args> void l(const Args&... args) const { Logger::getInstance().log(args...); }
